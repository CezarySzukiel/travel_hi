...
Revision ID: e684ceeb11a3
Revises: 278812250ec5
Create Date: 2025-10-05 06:17:03.569954
...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('ACCIDENT', 'TRAFFIC_JAM', 'ROADBLOCK', 'ROADWORK', 'DELAY', 'OTHER', name='report_type'), nullable=False),
    ...
    sa.Column('denials', sa.Integer(), nullable=False),
